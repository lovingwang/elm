...
<form    action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text"  class="form-control" name="name" value="{{$article->name}}" style="width: 500px" id="exampleInputEmail1" placeholder="请输入活动名称">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="date"  value="{{$article->start_time}}"  name="start_time" >

    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">结束时间</label>
        <input type="date"  value="{{$article->end_time}}"  name="end_time" >
